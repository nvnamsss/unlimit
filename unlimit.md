...
**Repository:** github.com/voidforge-studios/unlimit  
**Go Version:** 1.24.0  
...
|------|-------------|-------------|
| Algo | Generic algorithms and data structures including LRU/LFU caches, trees, graphs, bitmaps, and specialized structures for high-performance applications | github.com/voidforge-studios/unlimit/algo |
...
| name | description | import path |
|------|-------------|-------------|
| Cache | Unified caching interface with multiple backend implementations (Redis, Memory, LRU). Supports key-value, hash, bitmap, and list operations | github.com/voidforge-studios/unlimit/cache |
...
|------|-------------|-------------|---------------|
| Efflux | Background job scheduling, worker pools, event-driven workflows, and polling systems for concurrent task processing | github.com/voidforge-studios/unlimit/efflux | /home/namnv/git/unlimit/docs/efflux.md |
...
| name | description | import path |
|------|-------------|-------------|
| Collections | Design patterns and utilities including iterators, retry mechanisms, and chain of responsibility | github.com/voidforge-studios/unlimit/collections |
...
| name | description | import path |
|------|-------------|-------------|
| Database | Unified database interfaces for SQL (GORM) and MongoDB with connection pooling and transaction support | github.com/voidforge-studios/unlimit/database |
...
| name | description | import path | documentation |
|------|-------------|-------------|---------------|
| Trigger | Warcraft III-inspired trigger system for event-driven programming. Event-condition-action pattern | github.com/voidforge-studios/unlimit/trigger | /home/namnv/git/unlimit/docs/trigger.md |
...
| name | description | import path |
|------|-------------|-------------|
| Storage | Unified interface for object storage systems (S3, MinIO, etc.) | github.com/voidforge-studios/unlimit/storage |
...
| name | description | import path |
|------|-------------|-------------|
| Scheduler | Task scheduler with interval, cron, and one-off schedule support | github.com/voidforge-studios/unlimit/scheduler |
...
| name | description | import path |
|------|-------------|-------------|
| Utility | Helper functions for array operations, type conversion, file utilities, and versioning | github.com/voidforge-studios/unlimit/utility |
...
| name | description | import path |
|------|-------------|-------------|
| Logger | Zap-based structured logging with field support | github.com/voidforge-studios/unlimit/logger |
...
| name | description | import path |
|------|-------------|-------------|
| Messages | Message broker integrations for Kafka and NATS | github.com/voidforge-studios/unlimit/messages |
...
| name | description | import path |
|------|-------------|-------------|
| Middlewares | HTTP middlewares for Gin framework providing authentication and authorization | github.com/voidforge-studios/unlimit/middlewares |
...
| name | description | import path |
|------|-------------|-------------|
| Optz | High-performance object pooling for resource reuse and optimization | github.com/voidforge-studios/unlimit/optz |
...
| name | description | import path |
|------|-------------|-------------|
| Gen | ID generation and data generators for unique identifiers | github.com/voidforge-studios/unlimit/gen |
...
| name | description | import path |
|------|-------------|-------------|
| State | Finite state machine implementation with transitions and lifecycle hooks | github.com/voidforge-studios/unlimit/state |
...
| name | description | import path |
|------|-------------|-------------|
| Orchestrator | Complex workflow orchestration with task dependencies and execution control | github.com/voidforge-studios/unlimit/orchestrator |
